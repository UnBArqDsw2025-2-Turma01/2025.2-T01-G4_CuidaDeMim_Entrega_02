...
| **Daniel Ferreira** | 1. Modelagem dos métodos das classes, `Endereco`,`Conversa` e `Mensagem` e seus atributos/métodos essenciais. | Excelente | Commits, Vídeo Comprobatório |
